package com.LeetCode.Solutions.parellelcourses3;

public class parellelcourses {
    public static void main(String[] args) {
        Solution s = new Solution();
        int[][] relation = new int[][]{{1, 5}, {2, 5}, {3, 5}, {4, 5}, {3, 4}};
        int[] time = new int[]{1, 2, 3, 4, 5};
        System.out.println(s.minimumTime(5, relation, time));
    }
